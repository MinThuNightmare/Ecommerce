	...
	<main id="main" class="main-site left-sidebar">
		...
		<div class="container">
			...
			<div class="row">
                ...
                <a
                  class="text-decoration-none fs-2 border"
                  href="{{$details->url($i)}}"
                >
                  1 2</a
                >
                  ...
                  <i class="bx bxs-right-arrow"></i>
					...
					<div class="wrap-pagination-info">
						<ul class="page-numbers">
                            <li><a class="page-number-item next-link" href="{{ $products->previousPageUrl() }}" >Previous</a></li>

                            @for($i=1;$i<=$products->lastPage();$i++)
                            <li ><a class="page-number-item {{ ($products->currentPage() == $i) ? 'current' : '' }} " href="{{$products->url($i)}}">{{$i}}</a></li>

                                {{-- <a class="text-decoration-none fs-2 border" href="{{$products->url($i)}}">{{i}}</a> --}}
                                @endfor
